$(function(){
	...
	function initialize() {
	  ...
	  var mapProp = {
	    center:new google.maps.LatLng(-19.97786545,-44.05610049),
	    zoom:14,
	   	scrollwheel: false,
	    styles: [{
	    stylers: [{
	...
	initialize();
	addMarker(-19.97786545,-44.05610049,'',"Igreja do Evangelho Quadrangular Lindeia",undefined,true);
	...
	function carregarDinamico(){
		$('[realtime]').click(function(){
			...
			setTimeout(function(){
				initialize();
				addMarker(-19.97786545,-44.05610049,'',"Minha casa",undefined,false);
